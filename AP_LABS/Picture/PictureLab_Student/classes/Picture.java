...
public class Picture extends SimplePicture 
{
  ...
  public void mirrorDiagonal()
  {
    ...
    for (int col = 0; col < width; col++)
    {
      ...
      {
        topPixel = pixels[row][col];
        botPixel = pixels[row-height][col];
        topPixel.setColor(botPixel.getColor());
  ...
  public void mirrorArms()
  {
    ...
    for (int row = 158; row < 197; row++)
    {
      ...
      for (int col = 105; col < mirrorPoint; col++)
      {
        ...
        leftPixel = pixels[row][col];      
        rightPixel = pixels[mirrorPoint - row + mirrorPoint/2]                       
                         [col];
        rightPixel.setColor(leftPixel.getColor());
		count++;
	}
  ...
  public void myCollage()
  {
	...
	Picture flow3 = new Picture("arch.jpg");
    this.copy(flower1,0,0);
    this.copy(flower2,100,0);
    this.copy(flow3,200,0);
    Picture flowerNoBlue = new Picture(flower2);
    flowerNoBlue.zeroBlue();
	Picture fowno = new Picture(flower1);
	fowno.negate();
	Picture fowo = new Picture(flow3);
	fowno.greyscale();
    this.copy(flowerNoBlue,300,0);
    this.copy(fowno,400,0);
    this.copy(fowo,500,0);
    this.mirrorVertical();
    this.write("collage.jpg");
  }
